...
public class DatabaseManager {
    ...
    private DatabaseManager() {
        liteOrm = LiteOrm.newCascadeInstance(AppData.getInstance(), "mydata.db" ) ;
    }
    ...
    public <T> int setUpdate(T t, ColumnsValue cv) {
        return liteOrm.update(t,cv, ConflictAlgorithm.None);
    }
}
