...
import static com.hndl.ui.receiver.USBDiskReceiver.ACTION_USB_PERMISSION;
...
public class UsbHelper {
    ...
    //回调
    private USBDiskReceiver.UsbListener usbListener;
    //当前路径
    private UsbFile currentFolder = null;
    //TAG
    private static String TAG = "UsbHelper";

    public UsbHelper(Context context, USBDiskReceiver.UsbListener usbListener) {
